...
/*   Updated: 2021/12/21 12:15:00 by msanjuan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
int	checkNextTileFoe_bonus(t_data *data, int direction, char tile)
{
...
*/
int		loseGame_bonus(t_data *data)
{
...
*/
void	moveFoe_bonus(t_data *data, int direction)
{
